...
ob_start();
?>
<ul class="footer_col4">
	<?php 
		  $rowSetting  =  $funMenuObj->menuSettingByID(15);
		  ...
		  while($rowMainMenu =  $db->result($resultMainMenu)){	
		   ...
		   ?>
	<li class="<?php echo ($rowMainMenu->menu_link=='home')?"current-menu-item":""; ?> nav_top"><a href="<?php echo $menu_link;?>" target="<?php echo $link_type;?>"  class="parent" id="id_menu_<?php echo $main_menu_id?>" data-id="<?php echo "data_menu_id_".$main_menu_id; ?>"><span><?php echo $rowMainMenu->name; ?></span></a>
		<?php
...
<?php
$cms['module:footer_col4'] = ob_get_clean();