...
$view  = $_GET['action'];
		...
		{
		  $id   =   $_GET['aid'];
		    $rowEdit =  $funBookingObj  -> replybookingPageSel($id);			?>

<div class="tblform">
  <table width="100%" border="0" cellpadding="5" cellspacing="5" class="table_head_css" >
    <tr >
