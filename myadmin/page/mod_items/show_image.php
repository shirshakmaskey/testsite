...
<img src="<?php echo base_url(APPLICATIONS);?>timthumb/timthumb.php?src=<?php echo base_url('uploads/images/items/'.$val); ?>&w=100&h=100"><br>
<input type="text" name="image_title[]" class="form-control" placeholder="Title" >
<input type="checkbox" name="image_arr[]"  value="<?php echo $val; ?>">&nbsp;<small>Select</small>
</div>
<?php } ?>