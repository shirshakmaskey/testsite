...
$_SESSION['successMsg']	=	"";
$result  =  $funCustomObj->dataList();
$num =  $db->num_rows($result);
?>
<div class="page-header">
<div class="row">
				<!-- Page header, center on small screens -->
				<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-tasks page-header-icon"></i>&nbsp;&nbsp;Manage Custom Blocks</h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example" width="100%">
	...
	<?php if($num>0){
		...
		<tr>
			...
			<td><?=$row->position;?></td>
			<td><?php $image	=	$row->image;if(file_exists(FCPATH."uploads/images/custom/$image") and !empty($image))?><img src="<?php echo base_url(APPLICATIONS."timthumb/timthumb.php?src=".base_url()."uploads/images/custom/$image&w=100&h=46"); ?>" data-thumb="<?php echo base_url("uploads/images/custom/$image"); ?>" alt="" /></td>
			<td><?=$row->sortorder?></td>
...
{  
   	$.post(admin_url+'page/mod_custom/ajax.php',{id:id,mode:'change_status'},function(data){
