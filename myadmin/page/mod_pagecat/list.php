...
<div class="page-header">
			...
			<div class="row">
				...
				<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-tasks page-header-icon"></i>&nbsp;&nbsp;Manage Pages Category</h1>
...
<script type="text/javascript" charset="utf-8" id="init-code">
		$(document).ready(function() {
			...
			{  
				$.post(admin_url+'page/mod_pagecat/ajax.php',{id:id,mode:'change_status'},                    function(data){
