...
<a class="btn btn-primary btn-sm" href="form-<?php echo $module; ?>-<?php echo encode($row->artist_id);?>">
  ...
  &nbsp;&nbsp;
  <button type="button" class="btn btn-primary btn-sm" id="cancel" name="cancel" value="Cancel" onclick="window.location.href='lists-<?php echo $module; ?>-<?php echo encode($row->artist_id);?>';"><?php echo @$artist_row->artist_name?> 's Songs Management</button>

  &nbsp;&nbsp;        
  <a class="btn btn-primary btn-sm" href="all-<?php echo $module?>">Manage Songs</a>
...
<iframe title="YouTube video player" class="youtube-player" type="text/html" width="100%" height="120" src="http://www.youtube.com/embed/<?php echo $video_code;?>" frameborder="0" allowFullScreen></iframe>
                  ...
                  <tr>
                    <td>Lyrics</td>
                    <td><?php echo html_entity_decode( $row->lyrics_file );?></td>
                  </tr>

                  <tr>
                    <td>Details</td>
                    <td><?php echo isset($row->detail)?html_entity_decode( $row->detail):''?></td>
                  </tr>
