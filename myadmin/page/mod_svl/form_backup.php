          ...
          <input type="hidden" name="artist_id" id="artist_id" value="<?php echo @encode($artist); ?>" />
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <option value="popular">Pop Music</option>
            ...
            <?php
				...
				if(file_exists(FCPATH."uploads/lyrics/".$lyrics_file) and !empty($lyrics_file))
			{?>
            <div class="form-group">
            	<label for="inputImage" class="col-sm-2 control-label">Old Lyrics File</label>
                <div class="col-sm-6">
                	<a target="_blank" href="<?php echo base_url("uploads/lyrics/".$lyrics_file);?>">Lyrics File</a>
                </div>
            </div>
            <?php }?>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="hidden" name="hidden_lyrics" value="<?php echo $lyrics_file?>"> 
                </div> 
            </div>
