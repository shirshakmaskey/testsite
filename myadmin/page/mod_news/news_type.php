...
$pages   =        $funNewsObj -> newsTypeList($module,$contentPage,$sortField,$sortBy,$searchQu);
?>
...
<div class="page-header">
			...
			<div class="row">
				...
				<h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-tasks page-header-icon"></i>&nbsp;&nbsp;News Catagories</h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example" width="100%">
 <?php if($pages[0]>0){?>
	...
	<tr <?php echo (($altCol%2)>0)?"class='even'":"class='odd'";?>>
		...
		<td><?php echo date("F d,Y",strtotime($rows["created_at"]));?></td>
		...
		<td align="center"><a href="viewtype-<?php echo $module; ?>-<?php echo encode($rows["id"])?>"  title="View"><span class="glyphicon glyphicon-eye-open"></span></a>
		<a href="form_type-<?php echo $module; ?>-<?=encode($rows["id"])?>" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
		<a href="page/mod_<?php echo $module; ?>/act_type.php?aid=<?php echo encode($rows["id"]);?>&amp;action=delete" onclick="return confirm('Are you sure you want to delete this row!!');" title="Delete"><span class="glyphicon glyphicon-trash"></span></a></td>	
	</tr>
